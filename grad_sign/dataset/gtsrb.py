...
class GTSRB:
    ...
    def targets(self):
        ...
        if hasattr(self.train_dataset, '_samples'):
            return [label for _, label in self.train_dataset._samples]
        else:
            return None
    @property
    def name(self):
    ...
    def __init__(self,
        ...
        if n_classes is not None:
            # Filter samples for the first n_classes
            train_samples = [s for s in self.train_dataset._samples if s[1] < n_classes]
            self.train_dataset._samples = train_samples
        ...
        if n_classes is not None:
            # Filter samples for the first n_classes
            test_samples = [s for s in self.test_dataset._samples if s[1] < n_classes]
            self.test_dataset._samples = test_samples
        ...
        self.templates = get_templates('gtsrb')
